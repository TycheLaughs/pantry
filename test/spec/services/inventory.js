...
describe('Service: inventory', function () {
  ...
  describe('Functions: inventory functions', function(){
    ...
    describe('Functions: processAmount and processFood', function(){
    ...
    describe('Functions: addNewFood, updateFood, removeFood', function(){
    ...
    describe('Function: findFood', function(){
    ...
    describe('Function: removeFood', function(){
